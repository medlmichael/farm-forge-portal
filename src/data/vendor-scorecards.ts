  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        weight: 15,
        score: 4,
        notes: "Supports email, text, and push notifications across member workflows.",
        vsClubAutomation: "stronger",
        vsClubAutomationNotes: "Multi-channel native notifications may improve engagement if configured well.",
      },
      {
        category: "Billing/subscriptions + refunds",
        weight: 15,
        ...
        vsClubAutomation: "comparable",
        vsClubAutomationNotes: "Likely comparable for club billing operations; confirm refund and reconciliation detail.",
      },
      {
        category: "Staff roles/permissions + auditability",
        weight: 10,
      ...
      },
      {
        ...
        weight: 5,
        score: 4,
        notes: "API docs available and integration guidance published.",
        vsClubAutomation: "comparable",
        vsClubAutomationNotes: "Good signal on integration readiness; verify rate limits and webhook/event model.",
      },
      {
        category: "Migration effort + support",
        weight: 5,
        score: 4,
        notes: "Guided onboarding and member import reduce implementation risk; widget examples and admin resources are mature.",
        vsClubAutomation: "stronger",
        vsClubAutomationNotes: "Structured onboarding path is a positive for faster rollout confidence.",
      },
    ],
    summary:
      "Strong core operations candidate with mature onboarding, communications, and reporting. Recommend trial validation on booking edge cases, role granularity, and API/webhook limits before final selection.",
    status: "strong-fit",
  },
  {
    key: "mindbody",
